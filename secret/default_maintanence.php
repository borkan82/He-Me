...
<div class="empty-account-page">
    <div class="container">
        <div class="row congratz">
            <h1>Site is in maintanence!</h1><em></em>
            <h2 id="pathName"><em></em></h2>
        </div>
        <div class="row message">
            <p>Website <span id="website" style="word-break:break-all;"></span> is updating in moment.</p>
        </div>
        <div class="col-xs-12">
        ...
        <div class="footer">
            <div class="row">
                <div class="text-center" style="margin-bottom: 10px;">
                    <a href="http://www.taipanstudio.com" rel="nofollow">Updating</a> |

                </div>
                <div class="copyright text-center">
                    Help-ME © <?php echo date("Y"); ?>. All rights reserved
                </div>
            </div>
        </div>
    </div>
